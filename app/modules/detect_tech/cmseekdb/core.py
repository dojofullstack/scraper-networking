...
import detect_tech.deepscans.core as advanced # Deep scan and Version Detection functions
import detect_tech.cmseekdb.basic as cmseek # All the basic functions
import detect_tech.cmseekdb.sc as source # Contains function to detect cms from source code
import detect_tech.cmseekdb.header as header # Contains function to detect CMS from gathered http headers
import detect_tech.cmseekdb.cmss as cmsdb # Contains basic info about the CMSs
import detect_tech.cmseekdb.robots as robots
import detect_tech.cmseekdb.generator as generator
import detect_tech.cmseekdb.result as result
